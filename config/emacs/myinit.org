...
*** TODO spaceline not working on terminal (going back to default: doom?)
#+BEGIN_SRC emacs-lisp
  (use-package all-the-icons :ensure t :straight t)

  (let ((setting-modeline? t) (curr-modeline work-mode-modeline-preference))
  (while setting-modeline?
  (catch 'modeline-switch

        (cond
         ((eq curr-modeline 'powerline)
         ...
         ((eq curr-modeline 'doom-modeline)
         ...
         ((eq curr-modeline 'spaceline)
          (unless (display-graphic-p)
            (message "your preffered modelines 'spaceline is not working on terminal: going back to: %s" 'doom-modeline)
            (setq curr-modeline 'doom-modeline)
            (throw 'modeline-switch 'doom-modeline))
          ...
          (use-package eyeliner
            ...
            :config
            (progn
              (autoload 'projectile-project-p "projectile") ; eyeliner will complain without it
              (require 'eyeliner)
              (eyeliner/install)))
          (setq setting-modeline? nil))))))
