...
;                    (lambda () (set-input-method "korean-byeoru-uim")))
          ...
          (create-fontset-from-fontset-spec
           "-CTDB-Fira Code Retina-*-*-*--0-0-0-0-m-0-fontset-firacode_kr")
          (set-fontset-font "fontset-firacode_kr" 'unicode
                            (font-spec :name "FantasqueSansMono Nerd Font Mono" :size 13))
          (set-fontset-font "fontset-firacode_kr" 'ascii
                            (font-spec :name "Fantasque Sans Mono" :size 14))
          (set-fontset-font "fontset-firacode_kr" 'hangul
  ;                          (font-spec :name "Noto Sans CJK KR"))
                            (font-spec :name "KoPub Batang"))
          (set-fontset-font "fontset-firacode_kr"
                            (cons (decode-char 'ucs #x1f170)
                                  (decode-char 'ucs #x1fad6))
                            (font-spec :name "Segoe UI Emoji"))
          (create-fontset-from-fontset-spec
           "-Amazon-Bookerly-*-*-*--0-0-0-0-p-0-fontset-book_kr")
          (set-fontset-font "fontset-book_kr" 'ascii
                            (font-spec :name "Bookerly" :size 15))
          (set-fontset-font "fontset-book_kr" 'hangul
                            (font-spec :name "KoPub Batang" :size 15))
          (setq face-font-rescale-alist
                '(
                  (".*fantasque sans mono.*" . 1.0)
                  ))
          ...
          (add-to-list 'default-frame-alist (cons 'font "fontset-firacode_kr"))
